...
output_gray_image = cv2.equalizeHist(inputImage[H1:H2,W1:W2,0])

tmp1 = np.copy(inputImage)
tmp1[H1:H2,W1:W2,0] = output_gray_image

cv2.imshow("luv_histeq", cv2.cvtColor(tmp1,cv2.COLOR_LUV2BGR))
